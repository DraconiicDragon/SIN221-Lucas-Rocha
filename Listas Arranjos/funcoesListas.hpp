...
int localizaItem(TipoLista *lista, int id);       // Procura um item usando o id e retorna sua posição
void removeItem(TipoLista *lista, int id);        // Remove um item usando o id
void imprimeLista(TipoLista lista);               // Imprime o id de todos os itens
